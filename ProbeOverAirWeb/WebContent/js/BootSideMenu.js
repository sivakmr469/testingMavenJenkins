(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		newCode += "	<img class=\"glyphicon glyphicon-chevron-right\" src=\"images/slide-in.png\"/>&nbsp; <img class=\"glyphicon glyphicon-chevron-left\" src=\"images/slide-out.png\" />&nbsp;\n";
		newCode += "</div>\n";
...
function toggleArrow(toggler, side){
	if(side=="left"){
		...
		$(toggler).children(".glyphicon-chevron-left").css({'display': 'block','top': '-121px'});
